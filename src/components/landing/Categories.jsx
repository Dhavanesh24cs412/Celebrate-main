...
const Categories = () => {
  ...
  const categories = [
    { name: "Weddings", desc: "Make your big day magical", icon: <Heart size={20} />, img: "/landing-assets/mockup_hero_arch.png" },
    { name: "Engagements", desc: "Celebrate your new beginning", icon: <Sparkles size={20} />, img: "/landing-assets/mockup_category_engagements.png" },
    { name: "Birthdays", desc: "Make birthdays unforgettable", icon: <Gift size={20} />, img: "/landing-assets/mockup_category_birthdays.png" },
    { name: "Anniversaries", desc: "Cherish every milestone", icon: <Camera size={20} />, img: "/landing-assets/mockup_category_anniversaries.png" },
    { name: "Naming Ceremonies", desc: "Beautiful beginnings", icon: <Heart size={20} />, img: "/landing-assets/mockup_category_naming.png" },
    { name: "Baby Showers", desc: "Welcome the little one", icon: <Baby size={20} />, img: "/landing-assets/mockup_category_baby_shower.png" },
    { name: "Corporate", desc: "Professional. Impactful.", icon: <Building size={20} />, img: "/landing-assets/category_corporate.png" }
  ];
