        ...
        <div className="cta-banner-card reveal reveal-zoom">
          <div className="cta-content reveal reveal-up reveal-delay-200">
            ...
            <div className="cta-actions">
              <button className="btn btn-gold" onClick={onGoogleLogin}>Get Started Now</button>
          ...
          <div className="cta-image-wrapper">
            ...
            <img src="/landing-assets/mockup_cta_banner.png" alt="Outdoor Event" className="cta-bg-img" />
          </div>
        </div>
      </div>
    </section>
